...
EvalMap::EvalMap(unsigned int nmbr_dims, const LIB::PWMapFact &fact, VarEnv &env)
  : nmbr_dims_(nmbr_dims), fact_(fact), env_(env) {}

LIB::Map EvalMap::operator()(AST::Natural v) const
{
  Util::ERROR("EvalMap: trying to evaluate Natural ", v, "\n");
...
{
  Util::ERROR("EvalMap: variable ", v, " is not a Map\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::UnaryOp v) const 
{
  Util::ERROR("EvalMap: trying to evaluate arithmetic UnaryOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::BinOp v) const 
{
  Util::ERROR("EvalMap: trying to evaluate arithmetic BinOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::Call v) const
{
  Util::ERROR("EvalMap: trying to evaluate Call ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::Interval v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate Interval ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::InterUnaryOp v) const
{
  Util::ERROR("EvalMap: trying to evaluate InterUnaryOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::InterBinOp v) const
{
  Util::ERROR("EvalMap: trying to evaluate InterBinOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::MultiDimInter v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate MultiDimInter ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::MDInterUnaryOp v) const
{
  Util::ERROR("EvalMap: trying to evaluate MDInterUnaryOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::MDInterBinOp v) const
{
  Util::ERROR("EvalMap: trying to evaluate MDInterBinOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::Set v) const 
{
  Util::ERROR("EvalMap: trying to evaluate Set ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::SetUnaryOp v) const 
{
  Util::ERROR("EvalMap: trying to evaluate SetUnaryOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::SetBinOp v) const 
{
  Util::ERROR("EvalMap: trying to evaluate SetBinOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::LinearExp v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate LinearExp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::LExpBinOp v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate LExpBinOp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::MDLExp v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate MDLExp ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::MDLExpBinOp v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate MDLExpBinOp ", v, "\n");
  return fact_.createMap(); 
}
...
{ 
  Util::ERROR("EvalMap: trying to evaluate PWLMap ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::SBG v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate SBG ", v, "\n");
  return fact_.createMap(); 
}

LIB::Map EvalMap::operator()(AST::DSBG v) const
{ 
  Util::ERROR("EvalMap: trying to evaluate DSBG ", v, "\n");
  return fact_.createMap(); 
}
