...
struct EvalInt : public boost::static_visitor<Util::INT> {
  ...
  Util::INT operator()(AST::MultiDimInter v) const;
  Util::INT operator()(AST::MDInterUnaryOp v) const;
  Util::INT operator()(AST::MDInterBinOp v) const;
  ...
  Util::INT operator()(AST::LExpBinOp v) const;
  Util::INT operator()(AST::MDLExp v) const;
  Util::INT operator()(AST::MDLExpBinOp v) const;
  Util::INT operator()(AST::LinearMap v) const;
  Util::INT operator()(AST::PWLMap v) const;
  Util::INT operator()(AST::SBG v) const;
  Util::INT operator()(AST::DSBG v) const;
