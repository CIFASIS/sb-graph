...
TEST_P(ParserTests, Parser)
{
  ...
  const std::string TEST_ROOT = "../../parser";

  const std::string TEST_DIR = TEST_ROOT + "/test_data/" + NAME;
  ...
  const std::string TEST_CMD = TEST_ROOT + "/results.sh " + NAME + " " + TEST_ROOT;
  std::system(TEST_CMD.c_str());

  const std::string RESULT_FILE = TEST_ROOT + "/test_data/" + NAME + "/" + NAME + ".passed";
