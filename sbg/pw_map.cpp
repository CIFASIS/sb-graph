...
void OrdPWMap::emplace(const Map &m)
{
  if (!m.dom().isEmpty()){
...
//TODO: solo sobreviven aquellos mapas con interseccion no vacia, pero podemos ahorrar computo de alguna manera?
