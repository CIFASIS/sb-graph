...
// Implementation 1: Non canonic piecewise linear maps --------------------------------------------

#define SETS_TYPE1 typename PW_TEMP_TYPE1::Sets

#define LMAPS_TYPE1 typename PW_TEMP_TYPE1::LMaps

PW_TEMPLATE1
PW_TEMP_TYPE1::PWLMapImp1() : ndim_(0) {}

PW_TEMPLATE1
PW_TEMP_TYPE1::PWLMapImp1(SETS_TYPE1 dom, LMAPS_TYPE1 lmap) : ndim_(0)
{
...
PW_TEMPLATE1
PW_TEMP_TYPE1::PWLMapImp1(SET_IMP dom) : ndim_(dom.ndim())
{
  Sets emptySets;
  LMaps emptyLMaps;
...
member_imp_temp(PW_TEMPLATE1, PW_TEMP_TYPE1, SETS_TYPE1, dom);
member_imp_temp(PW_TEMPLATE1, PW_TEMP_TYPE1, LMAPS_TYPE1, lmap);
member_imp_temp(PW_TEMPLATE1, PW_TEMP_TYPE1, int, ndim);

PW_TEMPLATE1
void PW_TEMP_TYPE1::addSetLM(SET_IMP s, LM_IMP lm)
{
...
PW_TEMPLATE1
void PW_TEMP_TYPE1::addLMSet(LM_IMP lm, SET_IMP s)
{
...
PW_TEMPLATE1
bool PW_TEMP_TYPE1::empty() { return dom_ref().empty() && lmap_ref().empty(); }

PW_TEMPLATE1
SET_IMP PW_TEMP_TYPE1::wholeDom()
{
  SET_IMP res;
...
PW_TEMPLATE1
SET_IMP PW_TEMP_TYPE1::image(SET_IMP s)
{
...
PW_TEMPLATE1
SET_IMP PW_TEMP_TYPE1::image() { return image(wholeDom()); }

PW_TEMPLATE1
SET_IMP PW_TEMP_TYPE1::preImage(SET_IMP s)
{
  LMapsIt itl = lmap_ref().begin();
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::compPW(PW_TEMP_TYPE1 pw2)
{
  ...
  if (aux.equivalentPW(pw2)) {
    ...
    for (SetsIt itdom1 = aux.dom_ref().begin(); itdom1 != aux.dom_ref().end(); ++itdom1) {
      if ((*itlm1).isId()) {
        ...
        if (!dom1.empty()) notId.addSetLM(dom1, *itlm1);
      }
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::compPW(int n)
{
  PWLMapImp1 res = *this;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minInvCompact(SET_IMP s)
{
  Sets domRes;
  LMaps lmRes;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minInv(SET_IMP s)
{
  if (!empty()) {
    // Initialization
...
//     aren't equivalent
PW_TEMPLATE1
bool PW_TEMP_TYPE1::equivalentPW(PW_TEMP_TYPE1 pw2)
{
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::restrictMap(SET_IMP newdom)
{
  if (!newdom.empty()) {
    Sets resdom;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::concat(PW_TEMP_TYPE1 pw2)
{
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::combine(PW_TEMP_TYPE1 pw2)
{
  Sets sres = dom();
  SetsIt its = sres.end();
  LMaps lres = lmap();
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::filterMap(bool (*f)(SET_IMP dom, LM_IMP lm))
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::offsetDomMap(PW_TEMP_TYPE1 pw2)
{
  Sets domRes;
...
// of the map.
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::offsetImageMap(ORD_CT<INT_IMP> offElem)
{
  LMaps lmres;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::addMap(PW_TEMP_TYPE1 pw2)
{
  Sets domres;
...
// the substraction of both linear maps
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::diffMap(PW_TEMP_TYPE1 pw2)
{
  Sets domres;
  SetsIt itdom = domres.begin();
  LMaps lmres;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::atomize()
{
  Sets dres;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::normalize()
{
  Sets domres;
  LMaps lmres;
...
// Else, return lm2
PW_TEMPLATE1
void PW_TEMP_TYPE1::minMapAtomSet(MI_IMP dom, LM_IMP lm1, LM_IMP lm2, LM_IMP lm3, LM_IMP lm4)
{
...
PW_TEMPLATE1
void PW_TEMP_TYPE1::minMapAtomSet(MI_IMP dom, LM_IMP lm1, LM_IMP lm2)
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
void PW_TEMP_TYPE1::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2, LM_IMP lm3, LM_IMP lm4)
{
  ORD_CT<Set> sres;
  ORD_CT<LMap> lres;
...
PW_TEMPLATE1
void PW_TEMP_TYPE1::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2, PWLMapImp1 pw3)
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
void PW_TEMP_TYPE1::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2)
{
  PWLMapImp1 res;
...
// Minimum of PWLMaps
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minMap(PW_TEMP_TYPE1 pw2)
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minMap(PW_TEMP_TYPE1 pw2, PW_TEMP_TYPE1 pw1)
{
  PWLMapImp1 res;
...
//   pw1 : C -> D
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minAdjCompMap(PW_TEMP_TYPE1 pw2, PW_TEMP_TYPE1 pw1)
{
  PWLMapImp1 res;
...
//   pw1 : A -> C
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minAdjCompMap(PW_TEMP_TYPE1 pw1)
{
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minAdjMap(PW_TEMP_TYPE1 pw2, PW_TEMP_TYPE1 pw1)
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::minAdjMap(PW_TEMP_TYPE1 pw1)
{
  SET_IMP dom1 = pw1.wholeDom();
  SET_IMP im1 = pw1.image(dom1);
  PWLMapImp1 idmap(im1);

  PWLMapImp1 res = minAdjMap(pw1, idmap);
  return res;
}

// PWLMap reduction
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::reduceMapN(int dim)
{
  PWLMapImp1 res;
...
PW_TEMPLATE1
PW_TEMP_TYPE1 PW_TEMP_TYPE1::mapInf(int n)
{
  PWLMapImp1 res = *this;

  if (!empty()) {
    int i = 1;
    PWLMapImp1 originalRes = res, oldRes;
...
PW_TEMPLATE1
bool PW_TEMP_TYPE1::operator==(const PW_TEMP_TYPE1 &other) const { return dom() == other.dom() && lmap() == other.lmap(); }

template struct PWLMapImp1<OrdCT, UniqueOrdCT, UnordCT, AtomPWLMap, LMap, Set, MultiInterval, Interval, INT, REAL>;

PW_TEMPLATE1
std::ostream &operator<<(std::ostream &out, const PW_TEMP_TYPE1 &pw)
{
...
// Implementation 2: Canonic piecewise linear maps ------------------------------------------------

#define SETS_TYPE2 typename PW_TEMP_TYPE2::Sets

#define LMAPS_TYPE2 typename PW_TEMP_TYPE2::LMaps

PW_TEMPLATE2
PW_TEMP_TYPE2::PWLMapImp2() : ndim_(0) {}

PW_TEMPLATE2
PW_TEMP_TYPE2::PWLMapImp2(SETS_TYPE2 dom, LMAPS_TYPE2 lmap) : ndim_(0)
{
  LMapsIt itl = lmap.begin();
  int dim1 = (*(dom.begin())).ndim();
  bool different = false;
...
PW_TEMPLATE2
PW_TEMP_TYPE2::PWLMapImp2(SET_IMP dom) : ndim_(dom.ndim())
{
  Sets emptySets;
  LMaps emptyLMaps;
...
member_imp_temp(PW_TEMPLATE2, PW_TEMP_TYPE2, SETS_TYPE2, dom);
member_imp_temp(PW_TEMPLATE2, PW_TEMP_TYPE2, LMAPS_TYPE2, lmap);
member_imp_temp(PW_TEMPLATE2, PW_TEMP_TYPE2, int, ndim);

PW_TEMPLATE2
void PW_TEMP_TYPE2::addSetLM(SET_IMP s, LM_IMP lm)
{
  dom_.insert(dom_ref().end(), s);
  lmap_.insert(lmap_ref().end(), lm);
  PWLMapImp2 auxpw(dom_, lmap_);
...
PW_TEMPLATE2
void PW_TEMP_TYPE2::addLMSet(LM_IMP lm, SET_IMP s)
{
  dom_.insert(dom_ref().begin(), s);
  lmap_.insert(lmap_ref().begin(), lm);
  PWLMapImp2 auxpw(dom_, lmap_);
...
PW_TEMPLATE2
bool PW_TEMP_TYPE2::empty() { return dom_ref().empty() && lmap_ref().empty(); }

PW_TEMPLATE2
SET_IMP PW_TEMP_TYPE2::wholeDom()
{
  SET_IMP res;
...
PW_TEMPLATE2
SET_IMP PW_TEMP_TYPE2::image(SET_IMP s)
{
  LMapsIt itl = lmap_ref().begin();
...
PW_TEMPLATE2
SET_IMP PW_TEMP_TYPE2::image() { return image(wholeDom()); }

PW_TEMPLATE2
SET_IMP PW_TEMP_TYPE2::preImage(SET_IMP s)
{
  LMapsIt itl = lmap_ref().begin();
...
// Composition of PWLMaps
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::compPW(PW_TEMP_TYPE2 pw2)
{
  ...
  // Revisar el caso donde conjunto o mapas son vacíos
  PWLMapImp2 res(ress, reslm);
  if (res.empty()) res.set_ndim(this->ndim());
  return res;
}

PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::compPW(int n)
{
  PWLMapImp2 res = *this;
  PWLMapImp2 original = *this;
...
// in which case the minimum element of the dom is selected
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minInvCompact(SET_IMP s)
{
  Sets domRes;
  LMaps lmRes;
  ...
  PWLMapImp2 res(domRes, lmRes);
  return res;
}

PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minInv(SET_IMP s)
{
  if (!empty()) {
    // Initialization
    SetsIt itdom = dom_ref().begin();
    ...
    LMaps pw2lm;
    pw2lm.insert(pw2lm.begin(), lm1);
    PWLMapImp2 pw2(pw2dom, pw2lm);

    PWLMapImp2 invpw2 = pw2.minInvCompact(s);
    pw2 = invpw2;
    ...
    for (; itdom != dom_ref().end(); ++itdom) {
      ...
      LMaps pwilm;
      pwilm.insert(pwilm.begin(), *itlm);
      PWLMapImp2 pwi(pwidom, pwilm);

      PWLMapImp2 invpwi = pwi.minInvCompact(s);

      PWLMapImp2 minmap = pw2.minMap(invpwi);
      PWLMapImp2 combmap = invpwi.combine(pw2);
      pw2 = combmap;

      if (!minmap.empty()) {
        PWLMapImp2 combmap2 = minmap.combine(pw2);
        pw2 = combmap2;
      }
...
//     aren't equivalent
PW_TEMPLATE2
bool PW_TEMP_TYPE2::equivalentPW(PW_TEMP_TYPE2 pw2)
{
  SET_IMP dom1 = wholeDom();
  SET_IMP dom2 = pw2.wholeDom();
...
// Restrict doms (and consequently, linear maps) according to argument
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::restrictMap(SET_IMP newdom)
{
  if (!newdom.empty()) {
    Sets resdom;
    SetsIt itresdom = resdom.begin();
    ...
    return PWLMapImp2(resdom, reslm);
  }
...
// Append doms and maps of arguments to the current PWLMap
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::concat(PW_TEMP_TYPE2 pw2)
{
  SetsIt itdom = dom_ref().end();
  LMapsIt itlmap = lmap_ref().end();
...
// for elements that are exclusive of the doms of the argument
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::combine(PW_TEMP_TYPE2 pw2)
{
  Sets sres = dom();
  SetsIt its = sres.end();
  LMaps lres = lmap();
  ...
  PWLMapImp2 res(sres, lres);
  return res;
}

PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::filterMap(bool (*f)(SET_IMP dom, LM_IMP lm))
{
  PWLMapImp2 res;
...
// keeping the linear maps as they are. pw2 should be a bijective map
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::offsetDomMap(PW_TEMP_TYPE2 pw2)
{
  Sets domRes;
  SetsIt itDomRes = domRes.begin();
...
// of the map.
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::offsetImageMap(ORD_CT<INT_IMP> offElem)
{
  LMaps lmres;
  LMapsIt itlmres = lmres.begin();
...
// the substraction of both linear maps
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::addMap(PW_TEMP_TYPE2 pw2)
{
  Sets domres;
  SetsIt itdom = domres.begin();
  LMaps lmres;
  ...
  return PWLMapImp2(domres, lmres);
}
...
// the substraction of both linear maps
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::diffMap(PW_TEMP_TYPE2 pw2)
{
  Sets domres;
  SetsIt itdom = domres.begin();
  LMaps lmres;
...
// Transform each set in dom in a compact set (with only one atomic set)
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::atomize()
{
  Sets dres;
  SetsIt itdres = dres.begin();
  LMaps lres;
  ...
  return PWLMapImp2(dres, lres);
}

PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::normalize()
{
  Sets domres;
  LMaps lmres;
...
// Else, return lm2
PW_TEMPLATE2
void PW_TEMP_TYPE2::minMapAtomSet(MI_IMP dom, LM_IMP lm1, LM_IMP lm2, LM_IMP lm3, LM_IMP lm4)
{
  LM_IMP lm31 = lm3.compose(lm1);
  LM_IMP lm42 = lm4.compose(lm2);
...
PW_TEMPLATE2
void PW_TEMP_TYPE2::minMapAtomSet(MI_IMP dom, LM_IMP lm1, LM_IMP lm2)
{
  PWLMapImp2 res;
...
// lm3.compose(lm1) < lm4.compose(lm2); if not, lm2 is returned
PW_TEMPLATE2
void PW_TEMP_TYPE2::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2, LM_IMP lm3, LM_IMP lm4)
{
  ORD_CT<Set> sres;
  ORD_CT<LMap> lres;
...
PW_TEMPLATE2
void PW_TEMP_TYPE2::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2, PWLMapImp2 pw3)
{
  PWLMapImp2 res;
  ...
  LMaps lms2;
  lms2.insert(lms2.begin(), lm2);
  PWLMapImp2 pw1(doms, lms1);
  PWLMapImp2 pw2(doms, lms2);
...
PW_TEMPLATE2
void PW_TEMP_TYPE2::minMapSet(SET_IMP dom, LM_IMP lm1, LM_IMP lm2)
{
  PWLMapImp2 res;
...
// Minimum of PWLMaps
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minMap(PW_TEMP_TYPE2 pw2)
{
  PWLMapImp2 res;
...
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minMap(PW_TEMP_TYPE2 pw2, PW_TEMP_TYPE2 pw1)
{
  PWLMapImp2 res;
...
//   pw1 : C -> D
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minAdjCompMap(PW_TEMP_TYPE2 pw2, PW_TEMP_TYPE2 pw1)
{
  PWLMapImp2 res;
  ...
  if (auxsize == 1) {
    ...
    // Bijective in some dimensions, and constant in others
      ...
      // Compose
      PWLMapImp2 auxres = pw2.compPW(newinvpw);
      ...
      PWLMapImp2 replacedpw(auxres.dom(), lmres);
      res = replacedpw;
    }
  }
...
//   pw1 : A -> C
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minAdjCompMap(PW_TEMP_TYPE2 pw1)
{
  SET_IMP dom1 = pw1.wholeDom();
  SET_IMP im1 = pw1.image(dom1);
  PWLMapImp2 idmap(im1);

  return minAdjCompMap(pw1, idmap);
}

PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minAdjMap(PW_TEMP_TYPE2 pw2, PW_TEMP_TYPE2 pw1)
{
  PWLMapImp2 res;
...
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::minAdjMap(PW_TEMP_TYPE2 pw1)
{
  SET_IMP dom1 = pw1.wholeDom();
  SET_IMP im1 = pw1.image(dom1);
  PWLMapImp2 idmap(im1);

  PWLMapImp2 res = minAdjMap(pw1, idmap);
  return res;
}

// PWLMap reduction
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::reduceMapN(int dim)
{
  PWLMapImp2 res;
...
// PWLMap infinite composition
PW_TEMPLATE2
PW_TEMP_TYPE2 PW_TEMP_TYPE2::mapInf(int n)
{
  PWLMapImp2 res = *this;

  if (!empty()) {
    int i = 1;
    PWLMapImp2 originalRes = res, oldRes;
    while (!oldRes.equivalentPW(res) && i < n) {
      oldRes = res;
      res = res.compPW(originalRes);
      i++;
...
PW_TEMPLATE2
bool PW_TEMP_TYPE2::operator==(const PW_TEMP_TYPE2 &other) const { return dom() == other.dom() && lmap() == other.lmap(); }

template struct PWLMapImp2<OrdCT, UniqueOrdCT, UnordCT, AtomPWLMap, LMap, Set, MultiInterval, Interval, INT, REAL>;

PW_TEMPLATE2
std::ostream &operator<<(std::ostream &out, const PW_TEMP_TYPE2 &pw)
{
  ORD_CT<SET_IMP> d = pw.dom();
  typename ORD_CT<SET_IMP>::iterator itd = d.begin();
  ORD_CT<LM_IMP> l = pw.lmap();
