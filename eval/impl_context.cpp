...
LIB::SetAF& ImplContext::setFact() const
{
...
LIB::PWMapAF& ImplContext::pwFact() const
{
...
LIB::MatchingFact& ImplContext::matchFact() const
{
...
LIB::SCCFact& ImplContext::sccFact() const
{
...
LIB::TSFact& ImplContext::tsFact() const
{
...
LIB::CVFact& ImplContext::cvFact() const
{
...
void ImplContext::setSetFact(SetFactPtr fact)
{
  set_fact_ = std::move(fact);
}

void ImplContext::setPwFact(PWMapFactPtr fact)
{
  pw_fact_ = std::move(fact);
}

void ImplContext::setMatchFact(MatchFactPtr fact)
{
  match_fact_ = std::move(fact);
}

void ImplContext::setSccFact(SCCFactPtr fact)
{
  scc_fact_ = std::move(fact);
}

void ImplContext::setTSFact(TSFactPtr fact)
{
  ts_fact_ = std::move(fact);
}

void ImplContext::setCVFact(CVFactPtr fact)
{
